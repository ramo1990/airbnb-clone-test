...
from .views import CancelReservationView, CreateReservationView, ReservationsByListingView, UserReservationsView, HostReservationsView
...
urlpatterns = [
    ...
    path("reservations/host/", HostReservationsView.as_view(),  name='host-reservation'),
]